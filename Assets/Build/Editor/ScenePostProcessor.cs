...
public class ScenePostProcessor
{
    ...
    public static void OnPostProcessScene()
    {
        ...
        //AddBuildInfo();
        /*
        if (!BuildPipeline.isBuildingPlayer && Game.HasInitialize == false)
        {

			if (SceneManager.GetActiveScene().name.StartsWith("__")) return;

            var gamePrefab = AssetDatabase.LoadAssetAtPath("Assets/BuildAsset/Prefabs/Game.prefab", typeof(GameObject));
            PrefabUtility.InstantiatePrefab(gamePrefab);
        }
        */
    }
