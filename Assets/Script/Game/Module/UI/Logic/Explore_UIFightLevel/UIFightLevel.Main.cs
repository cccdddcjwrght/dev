...
namespace SGame.UI{
	...
	public partial class UIFightLevel : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightLevel));

		private UI_FightLevelUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightLevelUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
