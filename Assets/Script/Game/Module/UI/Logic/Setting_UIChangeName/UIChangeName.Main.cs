...
namespace SGame.UI{
	...
	public partial class UIChangeName : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIChangeName));

		private UI_ChangeNameUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_ChangeNameUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
