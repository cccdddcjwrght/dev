...
namespace SGame.UI{
	...
	public partial class UIMask : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIMask));

		private UI_MaskUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_MaskUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
