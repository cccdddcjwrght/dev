...
namespace SGame.UI{
	...
	public partial class UIDailyTask : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIDailyTask));

		private UI_DailyTaskUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_DailyTaskUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
