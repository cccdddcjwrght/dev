...
namespace SGame.UI{
	...
	public partial class UIFightGift : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightGift));

		private UI_FightGiftUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightGiftUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
