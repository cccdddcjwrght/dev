...
namespace SGame.UI{
	...
	public partial class UIChangeHead : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIChangeHead));

		private UI_ChangeHeadUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_ChangeHeadUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
