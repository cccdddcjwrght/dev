...
namespace SGame.UI{
	...
	public partial class UIClubDetail : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIClubDetail));

		private UI_ClubDetailUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_ClubDetailUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
