...
namespace SGame.UI{
	...
	public partial class UIWorktablePanel : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIWorktablePanel));

		private UI_WorktablePanelUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_WorktablePanelUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
