...
namespace SGame.UI{
	...
	public partial class UIExploreAutoSet : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIExploreAutoSet));

		private UI_ExploreAutoSetUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_ExploreAutoSetUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
