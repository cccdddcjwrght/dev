...
namespace SGame.UI{
	...
	public partial class UIWorktable : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIWorktable));

		private UI_WorktableUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_WorktableUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
