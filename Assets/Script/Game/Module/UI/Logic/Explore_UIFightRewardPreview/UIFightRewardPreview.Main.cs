...
namespace SGame.UI{
	...
	public partial class UIFightRewardPreview : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightRewardPreview));

		private UI_FightRewardPreviewUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightRewardPreviewUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
