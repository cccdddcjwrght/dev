...
namespace SGame.UI{
	...
	public partial class UIClubMain : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIClubMain));

		private UI_ClubMainUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_ClubMainUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
