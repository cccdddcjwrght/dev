...
namespace SGame.UI{
	...
	public partial class UIFightEquipTips : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightEquipTips));

		private UI_FightEquipTipsUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightEquipTipsUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
