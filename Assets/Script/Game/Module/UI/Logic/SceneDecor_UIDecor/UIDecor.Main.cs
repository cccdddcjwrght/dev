...
namespace SGame.UI{
	...
	public partial class UIDecor : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIDecor));

		private UI_DecorUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_DecorUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
