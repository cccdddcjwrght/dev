...
namespace SGame.UI{
	...
	public partial class UIGuideFinger : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIGuideFinger));

		private UI_GuideFingerUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_GuideFingerUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
