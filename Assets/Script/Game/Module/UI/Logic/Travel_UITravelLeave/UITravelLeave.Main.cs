...
namespace SGame.UI{
	...
	public partial class UITravelLeave : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UITravelLeave));

		private UI_TravelLeaveUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			m_view = context.content as UI_TravelLeaveUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
