...
namespace SGame.UI{
	...
	public partial class UIClubFind : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIClubFind));

		private UI_ClubFindUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_ClubFindUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
