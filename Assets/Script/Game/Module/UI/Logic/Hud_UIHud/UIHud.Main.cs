...
namespace SGame.UI{
	...
	public partial class UIHud : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIHud));

		private UI_HudUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_HudUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
