...
namespace SGame.UI{
	...
	public partial class UIExplore : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIExplore));

		private UI_ExploreUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_ExploreUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
