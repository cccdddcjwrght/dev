...
namespace SGame.UI{
	...
	public partial class UIRankResult : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIRankResult));

		private UI_RankResultUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_RankResultUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
