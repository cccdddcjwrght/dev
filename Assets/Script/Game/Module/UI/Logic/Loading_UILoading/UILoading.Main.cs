...
namespace SGame.UI{
	...
	public partial class UILoading : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UILoading));

		private UI_LoadingUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_LoadingUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
