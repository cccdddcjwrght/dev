...
namespace SGame.UI{
	...
	public partial class UIFoodTip : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFoodTip));

		private UI_FoodTipUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_FoodTipUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
