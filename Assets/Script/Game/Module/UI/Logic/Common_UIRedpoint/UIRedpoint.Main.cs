...
namespace SGame.UI{
	...
	public partial class UIRedpoint : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIRedpoint));

		private UI_RedpointUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_RedpointUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
