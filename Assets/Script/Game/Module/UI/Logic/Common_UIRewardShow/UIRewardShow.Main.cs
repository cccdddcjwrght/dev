...
namespace SGame.UI{
	...
	public partial class UIRewardShow : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIRewardShow));

		private UI_RewardShowUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_RewardShowUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
