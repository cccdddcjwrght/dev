...
namespace SGame.UI{
	...
	public partial class UIFightItemDetail : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightItemDetail));

		private UI_FightItemDetailUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightItemDetailUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
