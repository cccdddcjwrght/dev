...
namespace SGame.UI{
	...
	public partial class UIExploreTool : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIExploreTool));

		private UI_ExploreToolUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_ExploreToolUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
