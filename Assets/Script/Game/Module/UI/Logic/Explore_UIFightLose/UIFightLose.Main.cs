...
namespace SGame.UI{
	...
	public partial class UIFightLose : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightLose));

		private UI_FightLoseUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightLoseUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
