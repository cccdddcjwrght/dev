...
namespace SGame.UI{
	...
	public partial class UIOffline : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIOffline));

		private UI_OfflineUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_OfflineUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
