...
namespace SGame.UI{
	...
	public partial class UIMonsterHunter : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIMonsterHunter));

		private UI_MonsterHunterUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_MonsterHunterUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
