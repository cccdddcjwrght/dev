...
namespace SGame.UI{
	...
	public partial class UILanguage : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UILanguage));

		private UI_LanguageUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_LanguageUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
