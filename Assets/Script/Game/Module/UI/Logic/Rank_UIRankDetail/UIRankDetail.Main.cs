...
namespace SGame.UI{
	...
	public partial class UIRankDetail : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIRankDetail));

		private UI_RankDetailUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_RankDetailUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
