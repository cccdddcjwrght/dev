...
namespace SGame.UI{
	...
	public partial class UIFightWin : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIFightWin));

		private UI_FightWinUI m_view;
		...
		public void OnInit(UIContext context)
		{
			...
			m_view = context.content as UI_FightWinUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
