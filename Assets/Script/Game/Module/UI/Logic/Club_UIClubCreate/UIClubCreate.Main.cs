...
namespace SGame.UI{
	...
	public partial class UIClubCreate : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UIClubCreate));

		private UI_ClubCreateUI m_view;

		public void OnInit(UIContext context)
		{
			context.onClose += OnClose;
			context.onShown += OnShow;
			m_view = context.content as UI_ClubCreateUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
