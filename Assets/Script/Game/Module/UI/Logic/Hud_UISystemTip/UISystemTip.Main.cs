...
namespace SGame.UI{
	...
	public partial class UISystemTip : IUIScript
	{
		private static ILog log = LogManager.GetLogger("ui." + nameof(UISystemTip));

		private UI_SystemTipUI m_view;

		public void OnInit(UIContext context)
		{
			context.onUninit += OnClose;
			m_view = context.content as UI_SystemTipUI;
			BeforeInit(context);
			InitUI(context);
			InitEvent(context);
			InitLogic(context);
