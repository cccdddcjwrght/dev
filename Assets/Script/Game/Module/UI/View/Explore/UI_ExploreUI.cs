...
namespace SGame.UI.Explore
{
    public partial class UI_ExploreUI : GLabel
    {
        ...
        public UI_FightEquip m_eq14;
        public UI_FightEquip m_eq15;
        public UI_FightEquip m_eq16;
        public UI_FightEquip m_eq20;
        public UI_ToolBtn m_tool;
        public UI_ToolBtn m_auto;
        public UI_ToolBtn m_find;
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_eq14 = (UI_FightEquip)GetChildAt(15);
            m_eq15 = (UI_FightEquip)GetChildAt(16);
            m_eq16 = (UI_FightEquip)GetChildAt(17);
            m_eq20 = (UI_FightEquip)GetChildAt(18);
            m_tool = (UI_ToolBtn)GetChildAt(20);
            m_auto = (UI_ToolBtn)GetChildAt(21);
            m_find = (UI_ToolBtn)GetChildAt(22);
            m_count = (GTextField)GetChildAt(25);
            m_help = (GButton)GetChildAt(28);
            m_hp = (UI_FightAttr)GetChildAt(29);
            m_atk = (UI_FightAttr)GetChildAt(30);
            m_power = (GTextField)GetChildAt(33);
            m_eqinfo = (UI_FightEquipInfo)GetChildAt(36);
            m_holder = (GGraph)GetChildAt(39);
            m_modeleffect = (GGraph)GetChildAt(40);
            m_mholder = (GGraph)GetChildAt(41);
            m_monster = (GLoader)GetChildAt(42);
            m_monstereffect = (GGraph)GetChildAt(43);
            m_battlemonster = (GGraph)GetChildAt(45);
            m_exptips = (GTextField)GetChildAt(46);
            m_fightBtn = (UI_FightBtn)GetChildAt(47);
            m_fightHp1 = (UI_FightHp)GetChildAt(48);
            m_fightHp2 = (UI_FightHp)GetChildAt(49);
            m_finger = (UI_FightFinger)GetChildAt(50);
