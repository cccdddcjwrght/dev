...
namespace SGame.UI.Explore
{
    public partial class UI_ExploreUI : GLabel
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_modeleffect = (GGraph)GetChildAt(35);
            m_mholder = (GGraph)GetChildAt(36);
            m_monster = (GLoader)GetChildAt(37);
            m_monstereffect = (GGraph)GetChildAt(38);
            m_battlemonster = (GGraph)GetChildAt(40);
            m_exptips = (GTextField)GetChildAt(41);
