...
{
    public class ClubBinder
    {
        public static void BindAll()
        {
            UIObjectFactory.SetPackageItemExtension(UI_ClubFindUI.URL, typeof(UI_ClubFindUI));
            UIObjectFactory.SetPackageItemExtension(UI_IconBtn.URL, typeof(UI_IconBtn));
            UIObjectFactory.SetPackageItemExtension(UI_ClubItem.URL, typeof(UI_ClubItem));
            UIObjectFactory.SetPackageItemExtension(UI_ClubIcon.URL, typeof(UI_ClubIcon));
            UIObjectFactory.SetPackageItemExtension(UI_ClubBtn.URL, typeof(UI_ClubBtn));
            UIObjectFactory.SetPackageItemExtension(UI_ClubCreateUI.URL, typeof(UI_ClubCreateUI));
