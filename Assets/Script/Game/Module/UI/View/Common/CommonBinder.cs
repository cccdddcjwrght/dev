...
namespace SGame.UI.Common
{
    public class CommonBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(UI_MinBtn.URL, typeof(UI_MinBtn));
            ...
            UIObjectFactory.SetPackageItemExtension(UI_RewardShowUI.URL, typeof(UI_RewardShowUI));
