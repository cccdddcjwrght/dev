...
namespace SGame.UI.Explore
{
	public static class UIExploreExt
	{
		...
		static public GObject SetFightAttrList(this GObject gObject, List<int[]> attrs, Action<GObject, object> call = null, string listName = "attrs", FightEquip compare = null)
		{
