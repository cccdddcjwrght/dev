    ...
    public class RankModule : Singleton<RankModule>
    {
        ...
        public IEnumerator ReqRankList(bool popReward = false) 
        {
            ...
            if (rankPanelData.rewards?.Length > 0) 
            {
                ...
                DataCenter.Instance.rankCacheData.rewards.Foreach((r) => Debug.Log(string.Format("------�洢���н���----��ǰ�������ͣ�{0}��ǰ����:{1}", r.id, r.rank)));
            } 
 
            if (popReward && DataCenter.Instance.rankCacheData.rewards.Length > 0) 
            {
                DataCenter.Instance.rankCacheData.rewards.Foreach((r) => Debug.Log(string.Format("------�����н���----��ǰ�������ͣ�{0}��ǰ����:{1}", r.id, r.rank)));
