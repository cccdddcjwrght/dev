...
public struct GuideRowData : IFlatbufferObject
{
  ...
  public int Condition(int j) { int o = __p.__offset(12); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int ConditionLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetConditionBytes() { return __p.__vector_as_span<int>(12, 4); }
#else
  public ArraySegment<byte>? GetConditionBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public int[] GetConditionArray() { return __p.__vector_as_array<int>(12); }
  public string Cmd { get { int o = __p.__offset(14); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCmdBytes() { return __p.__vector_as_span<byte>(14, 1); }
#else
  public ArraySegment<byte>? GetCmdBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public byte[] GetCmdArray() { return __p.__vector_as_array<byte>(14); }
  ...
  public float Width { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
  public float Height { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
  public int Angle { get { int o = __p.__offset(22); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public string StringParam { get { int o = __p.__offset(24); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStringParamBytes() { return __p.__vector_as_span<byte>(24, 1); }
#else
  public ArraySegment<byte>? GetStringParamBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public byte[] GetStringParamArray() { return __p.__vector_as_array<byte>(24); }
  public string UIPath { get { int o = __p.__offset(26); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUIPathBytes() { return __p.__vector_as_span<byte>(26, 1); }
#else
  public ArraySegment<byte>? GetUIPathBytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public byte[] GetUIPathArray() { return __p.__vector_as_array<byte>(26); }
  public float FloatParam(int j) { int o = __p.__offset(28); return o != 0 ? __p.bb.GetFloat(__p.__vector(o) + j * 4) : (float)0; }
  public int FloatParamLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<float> GetFloatParamBytes() { return __p.__vector_as_span<float>(28, 4); }
#else
  public ArraySegment<byte>? GetFloatParamBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public float[] GetFloatParamArray() { return __p.__vector_as_array<float>(28); }
  public int RealitySize(int j) { int o = __p.__offset(30); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int RealitySizeLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetRealitySizeBytes() { return __p.__vector_as_span<int>(30, 4); }
#else
  public ArraySegment<byte>? GetRealitySizeBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public int[] GetRealitySizeArray() { return __p.__vector_as_array<int>(30); }
  public int UISize(int j) { int o = __p.__offset(32); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int UISizeLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetUISizeBytes() { return __p.__vector_as_span<int>(32, 4); }
#else
  public ArraySegment<byte>? GetUISizeBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public int[] GetUISizeArray() { return __p.__vector_as_array<int>(32); }
  public int OffsetXY(int j) { int o = __p.__offset(34); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int OffsetXYLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetOffsetXYBytes() { return __p.__vector_as_span<int>(34, 4); }
#else
  public ArraySegment<byte>? GetOffsetXYBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public int[] GetOffsetXYArray() { return __p.__vector_as_array<int>(34); }
  public float Alpha { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
  public int TimeOut { get { int o = __p.__offset(38); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int Force { get { int o = __p.__offset(40); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<GameConfigs.GuideRowData> CreateGuideRowData(FlatBufferBuilder builder,
    ...
    GuideRowData.AddCondition(builder, conditionOffset);
  ...
  public static void StartGuideRowData(FlatBufferBuilder builder) { builder.StartTable(19); }
  ...
  public static void AddCondition(FlatBufferBuilder builder, VectorOffset conditionOffset) { builder.AddOffset(4, conditionOffset.Value, 0); }
  ...
  public static void AddCmd(FlatBufferBuilder builder, StringOffset CmdOffset) { builder.AddOffset(5, CmdOffset.Value, 0); }
  public static void AddIcon(FlatBufferBuilder builder, StringOffset IconOffset) { builder.AddOffset(6, IconOffset.Value, 0); }
  public static void AddWidth(FlatBufferBuilder builder, float width) { builder.AddFloat(7, width, 0.0f); }
  public static void AddHeight(FlatBufferBuilder builder, float height) { builder.AddFloat(8, height, 0.0f); }
  public static void AddAngle(FlatBufferBuilder builder, int angle) { builder.AddInt(9, angle, 0); }
  public static void AddStringParam(FlatBufferBuilder builder, StringOffset StringParamOffset) { builder.AddOffset(10, StringParamOffset.Value, 0); }
  public static void AddUIPath(FlatBufferBuilder builder, StringOffset UIPathOffset) { builder.AddOffset(11, UIPathOffset.Value, 0); }
  public static void AddFloatParam(FlatBufferBuilder builder, VectorOffset floatParamOffset) { builder.AddOffset(12, floatParamOffset.Value, 0); }
  ...
  public static void AddRealitySize(FlatBufferBuilder builder, VectorOffset RealitySizeOffset) { builder.AddOffset(13, RealitySizeOffset.Value, 0); }
  ...
  public static void AddUISize(FlatBufferBuilder builder, VectorOffset UISizeOffset) { builder.AddOffset(14, UISizeOffset.Value, 0); }
  ...
  public static void AddOffsetXY(FlatBufferBuilder builder, VectorOffset OffsetXYOffset) { builder.AddOffset(15, OffsetXYOffset.Value, 0); }
  ...
  public static void AddAlpha(FlatBufferBuilder builder, float alpha) { builder.AddFloat(16, alpha, 0.0f); }
  public static void AddTimeOut(FlatBufferBuilder builder, int TimeOut) { builder.AddInt(17, TimeOut, 0); }
