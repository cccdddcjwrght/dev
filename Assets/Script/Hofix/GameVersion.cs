...
namespace SGame
{
    ...
    public class GameVersion
    {
        ...
        public string[] resource_url; // 资源更新地址
        ...
        public void Copy(GameVersion other)
        {
            ...
            // 如果目标下载地址为空, 就使用原来的
            if (other.resource_url != null && other.resource_url.Length > 0) 
            {
                resource_url = new string[other.resource_url.Length];
                for (int i = 0; i < other.resource_url.Length; i++)
                    resource_url[i] = other.resource_url[i];
            }
        }
